...
This is a copy of the `PyVista example about PBR <https://docs.pyvista.org/version/stable/examples/02-plot/pbr#sphx-glr-examples-02-plot-pbr-py>`_.

(In this example, we disable the interactive plot as most of the rendering functionalities
are not available in the vtk-js backend)
